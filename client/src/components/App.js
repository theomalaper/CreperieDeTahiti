      ...
      <div>
        <header className="App-Nav-bar">
          ...
          <section className="Nav-bar-right">
            <a href="#presentation-page" className="Nav-bar-links react-links">Processus</a>
            <a href="#product-page" className="Nav-bar-links react-links">Gamme</a>
